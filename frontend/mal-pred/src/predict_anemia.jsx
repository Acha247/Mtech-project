  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if(count>0){
        ...
        const response = await axios.post("http://127.0.0.1:9000/predict-anemia", data);
